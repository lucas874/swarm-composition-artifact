...
START_R="echo 'Starting factory-robot of the Warehouse || Factory protocol.'; npm run start-factory-robot 2>&1 | tee -a $1;exec bash"
START_FL="echo 'Starting forklift of the Warehouse || Factory protocol.'; npm run start-forklift 2>&1 | tee -a $1;exec bash"
START_T="echo 'Starting transporter of the Warehouse || Factory protocol.'; npm run start-transporter 2>&1 | tee -a $1;exec bash"
START_D="echo 'Starting door of the Warehouse || Factory protocol.'; npm run start-door 2>&1 | tee -a $1;exec bash"
