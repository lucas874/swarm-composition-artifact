...
cargo criterion --offline --output-format quiet --plotting-backend disabled --bench composition_benchmark_short 2>out_criterion_short.txt&
bash $DIR/scripts/okkkk.sh
