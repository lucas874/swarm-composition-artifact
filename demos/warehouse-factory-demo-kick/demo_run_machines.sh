...
START_T="echo 'Starting transporter of the Warehouse || Factory protocol.'; npm run start-transporter;exec bash"
START_D="echo 'Starting door of the Warehouse || Factory protocol.'; npm run start-door;exec bash"
