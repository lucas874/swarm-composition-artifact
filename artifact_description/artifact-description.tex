...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Compositional Design, Implementation, and Verification of Swarms (Artifact)} %TODO Please add
...
\mdsum{5f5424765125c9441a163f4d5239bc1f}

% ARTIFACT: section specifying the size of the artifact master file uploaded
% to the Dagstuhl Research Online Publication Server
\artifactsize{1.03 GiB}
...
\bibliography{artifact-description}
