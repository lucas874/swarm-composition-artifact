...
* **The Warehouse || Factory demo:**
  ...
  * The implementations of T, D, and FL are obtained by automatically adapting the machine implementations from the warehouse demo to become correct for the composition. Similarly, the R role is implemented for the Factory protocol (shown in Figure 4, p. 2) and automatically adapted for the composition.
